...
const AddLink = (props) => {
	...
	// const [youtubeURLState, setYoutubeURLState] = useState({ t: ''});
	...
	const handleFinishYoutubeURL = e => {
		...
		text.current = text.current + `<iframe width="560" height="315" src="${value}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
